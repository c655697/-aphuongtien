...
% Delay
 O = 0 * sin(2 * pi * t);
% Jingle Bells Song
song = [    G2 G2 F2 E2 D2 E2 O G E2 D2 C2 G O G G E2 D2 C2 A O A A F2 E2 D2 G2 O G2 G2 G2 O G2 A2 G2 F2 D2 C2];
